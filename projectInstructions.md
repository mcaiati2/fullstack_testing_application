...
```md
GIVEN I am taking a tech quiz DONE
WHEN I click the start button DONE
THEN the quiz starts and I am presented with a question DONE
WHEN I answer a question DONE
THEN I am presented with another question DPME
WHEN all questions are answered DONE
THEN the quiz is over DONE
WHEN the quiz is over DONE
THEN I can view my score DONE
WHEN the quiz is over DONE
THEN I can start a new quiz DONE
```
